...
fun DrawingScreen(
    ...
    DrawingScreen(
        ...
        onWorkingDeleteFramesMenuLastClick = viewModel::onWorkingDeleteFramesMenuLastClick,
        onWorkingDeleteFramesMenuAllClick = viewModel::onWorkingDeleteFramesMenuAllClick,
...
private fun DrawingScreen(
    ...
    onWorkingDeleteFramesMenuLastClick: () -> Unit,
    onWorkingDeleteFramesMenuAllClick: () -> Unit,
    ...
    when (state) {
        is DrawingScreenState.Working -> {
            DrawingWorkingContent(
                ...
                onDeleteFramesMenuLastClick = onWorkingDeleteFramesMenuLastClick,
                onDeleteFramesMenuAllClick = onWorkingDeleteFramesMenuAllClick,
...
private fun Preview() {
    MyApplicationTheme {
        DrawingScreen(
            ...
            onWorkingDeleteFramesMenuLastClick = {},
            onWorkingDeleteFramesMenuAllClick = {},
